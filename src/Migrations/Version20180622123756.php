 ...
 */
class Version20180622123756 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE nina_configuration ADD theme VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE nina_module ADD idModule INT NOT NULL, ADD type VARCHAR(255) NOT NULL, DROP contenu');
        $this->addSql('ALTER TABLE nina_module_image ADD source VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE nina_page DROP contenu');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE nina_configuration DROP theme');
        $this->addSql('ALTER TABLE nina_module ADD contenu LONGTEXT NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:array)\', DROP idModule, DROP type');
        $this->addSql('ALTER TABLE nina_module_image DROP source');
        $this->addSql('ALTER TABLE nina_page ADD contenu LONGTEXT NOT NULL COLLATE utf8_unicode_ci');
    }
}
