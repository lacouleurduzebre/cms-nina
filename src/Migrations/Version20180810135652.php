 ...
 */
final class Version20180810135652 extends \Doctrine\DBAL\Migrations\AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nina_seo (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(255) NOT NULL, metaTitre LONGTEXT NOT NULL, metaDescription LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nina_page (id INT AUTO_INCREMENT NOT NULL, auteur_id INT DEFAULT NULL, auteur_derniere_modification_id INT DEFAULT NULL, page_originale_id INT DEFAULT NULL, langue_id INT DEFAULT NULL, seo_id INT DEFAULT NULL, titre LONGTEXT NOT NULL, date_creation DATETIME NOT NULL, date_publication DATETIME NOT NULL, date_depublication DATETIME DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, corbeille TINYINT(1) NOT NULL, titre_menu VARCHAR(255) DEFAULT NULL, INDEX IDX_2A202F6960BB6FE6 (auteur_id), INDEX IDX_2A202F69F6698E1C (auteur_derniere_modification_id), INDEX IDX_2A202F69320E6035 (page_originale_id), INDEX IDX_2A202F692AADBACD (langue_id), UNIQUE INDEX UNIQ_2A202F6997E3DD86 (seo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nina_page_categorie (nina_page_id INT NOT NULL, nina_categorie_id INT NOT NULL, INDEX IDX_E6E011658352D10 (nina_page_id), INDEX IDX_E6E0116548512DB3 (nina_categorie_id), PRIMARY KEY(nina_page_id, nina_categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nina_type_categorie (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, url VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nina_configuration (id INT AUTO_INCREMENT NOT NULL, langue_defaut_id INT DEFAULT NULL, page_accueil_id INT DEFAULT NULL, logo LONGTEXT NOT NULL, nom VARCHAR(255) NOT NULL, emailContact VARCHAR(255) NOT NULL, emailMaintenance VARCHAR(255) NOT NULL, emailNewsletter VARCHAR(255) NOT NULL, analytics LONGTEXT NOT NULL, editeur VARCHAR(255) NOT NULL, theme VARCHAR(255) DEFAULT NULL, meta_description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_B2A1BF5E968B03E4 (langue_defaut_id), UNIQUE INDEX UNIQ_B2A1BF5E777E0C5F (page_accueil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nina_module (id INT AUTO_INCREMENT NOT NULL, page_id INT NOT NULL, type VARCHAR(255) DEFAULT NULL, contenu LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', position INT DEFAULT NULL, class VARCHAR(255) DEFAULT NULL, INDEX IDX_A44CC7AEC4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nina_zone (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, region VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, position SMALLINT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nina_langue (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, abreviation VARCHAR(191) NOT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_3B3F940886B470F8 (abreviation), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nina_menu (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, region VARCHAR(255) NOT NULL, defaut TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
